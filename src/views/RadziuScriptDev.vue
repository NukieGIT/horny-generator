...
import { IGenshinCharacterInfoDefault, type ICharacterCardProps } from '@/ts/radziuScript/GenshinInfoAPI/RGenshinCharacterInfoTypes';
...
<template>
    <div>
        <form @submit.prevent>
            ...
            <UserButton @click="data.push(`test+${Math.floor(Math.random() * 10000)}`)">Test</UserButton>
        </form>
